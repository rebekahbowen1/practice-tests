...
public class Userpurchase {
	...
	String baseURL="http://www.public.integration.qa.noths.com/search?filter[category_id]=15000&page=2&search=find&term=&utf8=%E2%9C%93";
	WebDriverWait wait = new WebDriverWait(wd,5);
	
	
	@Test
	public void test () {
	//add a product to the basket (product page)
	wd.get(baseURL);
	wd.findElementByLinkText("Six Month Friday Night Curry Subscription").click();
